    ...
    private static final WorldEntity[][] mapEntities =
            {
                    ...
                    {Stone, Stone, Stone, Monster, Stone, Empty, Stone, Stone, Stone, Stone, Empty, Empty},
                    ...
                    {Empty, BombNumberDec, Empty, Empty, Empty, Empty, Empty, Empty, BombNumberInc, Empty, WorldEntity.Player, Princess}
            };
    public WorldStatic() {
        super(mapEntities);
    }
